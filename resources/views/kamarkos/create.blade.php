...
@section('title', 'Tambah Data Kamar Kos')
...
@section('content-header')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambah Data Kamar Kos</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/">Home</a></li>
              <li class="breadcrumb-item"><a href="/kamarkos">Kamar Kos</a></li>
              <li class="breadcrumb-item active">Tambah Data Kamar Kos</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="card">
        <div class="card-header">
            {{-- <h3 class="card-title">Form Tambah Kamar Kos</h3> --}}
